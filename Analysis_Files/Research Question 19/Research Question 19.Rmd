...
figure_folder_path  <- "C:/Users/DakotaLanghals/OneDrive - Royal Statistical Society/EPSRC Grant Funding/Figures/Research Question 19"
...
```{r}
## For the purposes of the report, EPSRC requested not having gaps between the presented RAGs. These organically arise in two places - RAG-04 is their NULL RAG, and was not included in the raw data. RAG-01 has too few observations in the raw data to reasonably analyse.

Q19RAGApplicants.df <- Q19RAGApplicants.df %>% filter(AnonRAG != "RAG-01") %>% 
  mutate(AnonRAG = case_when(AnonRAG == "RAG-02" ~ "RAG-01",
                             AnonRAG == "RAG-03" ~ "RAG-02",
                             AnonRAG == "RAG-05" ~ "RAG-03",
                             AnonRAG == "RAG-06" ~ "RAG-04",
                             AnonRAG == "RAG-07" ~ "RAG-05",
                             AnonRAG == "RAG-08" ~ "RAG-06",
                             AnonRAG == "RAG-09" ~ "RAG-07",
                             AnonRAG == "RAG-10" ~ "RAG-08",
                             AnonRAG == "RAG-11" ~ "RAG-09",
                             TRUE ~ AnonRAG))

Q19RAGAwardees.df <- Q19RAGAwardees.df %>% filter(AnonRAG != "RAG-01") %>% 
  mutate(AnonRAG = case_when(AnonRAG == "RAG-02" ~ "RAG-01",
                             AnonRAG == "RAG-03" ~ "RAG-02",
                             AnonRAG == "RAG-05" ~ "RAG-03",
                             AnonRAG == "RAG-06" ~ "RAG-04",
...
Q19RAGPanelists.df <- Q19RAGPanelists.df %>% filter(AnonRAG != "RAG-01") %>% 
  mutate(AnonRAG = case_when(AnonRAG == "RAG-02" ~ "RAG-01",
                             AnonRAG == "RAG-03" ~ "RAG-02",
                             AnonRAG == "RAG-05" ~ "RAG-03",
                             AnonRAG == "RAG-06" ~ "RAG-04",
...
Q19RAGReviewers.df <- Q19RAGReviewers.df %>% filter(AnonRAG != "RAG-01") %>% 
  mutate(AnonRAG = case_when(AnonRAG == "RAG-02" ~ "RAG-01",
                             AnonRAG == "RAG-03" ~ "RAG-02",
                             AnonRAG == "RAG-05" ~ "RAG-03",
                             AnonRAG == "RAG-06" ~ "RAG-04",
...
df_sex <- Q19RAGApplicants.df %>% filter(Sex != "Unknown" & Sex != "Not Disclosed")
df_ethnicity <- Q19RAGApplicants.df %>% filter(EthnicityBinary != "Unknown" & EthnicityBinary != "Not Disclosed")
df_nationality <- Q19RAGApplicants.df %>% filter(NationalityBinary != "Unknown" & NationalityBinary != "Not Disclosed")
df_disability <- Q19RAGApplicants.df %>% filter(Disability != "Unknown" & Disability != "Not Disclosed")
df_sex_ethnicity <- Q19RAGApplicants.df %>% filter(!str_detect(Sex_Ethnicity, "Unknown|Not Disclosed"))
df_age <- Q19RAGApplicants.df %>% filter(!str_detect(AgeRangeCollapsed, "Unknown|Not Disclosed"), !is.na(AgeRangeCollapsed))
...
df_sex <- Q19RAGAwardees.df %>% filter(Sex != "Unknown" & Sex != "Not Disclosed")
df_ethnicity <- Q19RAGAwardees.df %>% filter(EthnicityBinary != "Unknown" & EthnicityBinary != "Not Disclosed")
df_nationality <- Q19RAGAwardees.df %>% filter(NationalityBinary != "Unknown" & NationalityBinary != "Not Disclosed")
df_disability <- Q19RAGAwardees.df %>% filter(Disability != "Unknown" & Disability != "Not Disclosed")
df_sex_ethnicity <- Q19RAGAwardees.df %>% filter(!str_detect(Sex_Ethnicity, "Unknown|Not Disclosed"))
df_age <- Q19RAGAwardees.df %>% filter(!str_detect(AgeRangeCollapsed, "Unknown|Not Disclosed"), !is.na(AgeRangeCollapsed))
...
df_sex <- Q19RAGReviewers.df %>% filter(Sex != "Unknown" & Sex != "Not Disclosed")
df_ethnicity <- Q19RAGReviewers.df %>% filter(EthnicityBinary != "Unknown" & EthnicityBinary != "Not Disclosed")
df_nationality <- Q19RAGReviewers.df %>% filter(NationalityBinary != "Unknown" & NationalityBinary != "Not Disclosed")
df_disability <- Q19RAGReviewers.df %>% filter(Disability != "Unknown" & Disability != "Not Disclosed")
df_sex_ethnicity <- Q19RAGReviewers.df %>% filter(!str_detect(Sex_Ethnicity, "Unknown|Not Disclosed"))
df_age <- Q19RAGReviewers.df %>% filter(!str_detect(AgeRangeCollapsed, "Unknown|Not Disclosed"), !is.na(AgeRangeCollapsed))
...
df_sex <- Q19RAGPanelists.df %>% filter(Sex != "Unknown" & Sex != "Not Disclosed")
df_ethnicity <- Q19RAGPanelists.df %>% filter(EthnicityBinary != "Unknown" & EthnicityBinary != "Not Disclosed")
df_nationality <- Q19RAGPanelists.df %>% filter(NationalityBinary != "Unknown" & NationalityBinary != "Not Disclosed")
df_disability <- Q19RAGPanelists.df %>% filter(Disability != "Unknown" & Disability != "Not Disclosed")
df_sex_ethnicity <- Q19RAGPanelists.df %>% filter(!str_detect(Sex_Ethnicity, "Unknown|Not Disclosed"))
df_age <- Q19RAGPanelists.df %>% filter(!str_detect(AgeRangeCollapsed, "Unknown|Not Disclosed"), !is.na(AgeRangeCollapsed))
...
```{r save plots, echo = FALSE, eval=FALSE, include=FALSE}
figure_folder_path  <- "C:/Users/DakotaLanghals/OneDrive - Royal Statistical Society/EPSRC Grant Funding/Figures/Research Question 19"
