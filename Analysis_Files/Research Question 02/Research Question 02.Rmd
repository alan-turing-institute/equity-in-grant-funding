...
figure_folder_path  <- "C:/Users/DakotaLanghals/OneDrive - Royal Statistical Society/PROJ2023.002 - Data folder DL Pickup/Draft Outputs/Images/Note02"
table_folder_path   <- "C:/Users/DakotaLanghals/OneDrive - Royal Statistical Society/PROJ2023.002 - Data folder DL Pickup/Draft Outputs/Tables/Note02"
...
df_awardee <- CI_Tables$Awardee$Sex.df
df_reviewer <- CI_Tables$Reviewer$Sex.df
df_applicant <- CI_Tables$Applicant$Sex.df


df_panelist$Source <- "Panelists"
df_applicant$Source <- "Applicants (all)"
df_awardee$Source <- "Awardees (all)"
...
female_proportions <- ggplot(df_combined, aes(x = Year, y = Proportion*100, color = Source)) +
  ...
  labs(x = "Academic Year (Beginning)", 
       y = "Proportion (%)", 
  ...
  scale_color_manual(
    values = c(
        "Panelists" = RSSred,
        "Applicants (all)" = RSSblue,
        "Awardees (all)" = RSSgreen,
        "Reviewers" = RSSgold
    )
  ) +
...
df_awardee <- CI_Tables$Awardee$Eth.df
df_reviewer <- CI_Tables$Reviewer$Eth.df
df_applicant <- CI_Tables$Applicant$Eth.df
...
df_awardee <- CI_Tables$Awardee$Nat.df
df_reviewer <- CI_Tables$Reviewer$Nat.df
df_applicant <- CI_Tables$Applicant$Nat.df
...
df_awardee <- CI_Tables$Awardee$Dis.df
df_reviewer <- CI_Tables$Reviewer$Dis.df
df_applicant <- CI_Tables$Applicant$Dis.df
...
df_awardee <- CI_Tables$Awardee$Age.df
df_reviewer <- CI_Tables$Reviewer$Age.df
df_applicant <- CI_Tables$Applicant$Age.df
