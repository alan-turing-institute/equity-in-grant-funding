...
figure_folder_path  <- "C:/Users/DakotaLanghals/OneDrive - Royal Statistical Society/EPSRC Grant Funding/Figures/Research Question 20"
...
## Re-numbering the RAGs to avoid gaps in the numbers in the report - requested by EPSRC.
df <- df %>%  mutate(AnonRAG = case_when(AnonRAG == "RAG-02" ~ "RAG-01",
